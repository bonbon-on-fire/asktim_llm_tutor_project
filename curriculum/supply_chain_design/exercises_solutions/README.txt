...
(see meeting_notes/2026-07-01.md — "Add problem explanations to context via the
correct-answer input"). Leaking them into exercise prompt text would defeat the
tutor's Socratic design.

NOTE ON AVAILABILITY: On the live 2T2026 run, graded solutions are gated until
after each week's due date. Files here are captured only when the course reveals
"Show Answer" for free (post-due-date or on an archived run).
