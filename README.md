...
│   └── prompts/             # tutor_01.txt .. tutor_07.txt (versioned prompts; tutor_07 is the deployed default, both apps locked to it — tutor_05 guidance + math/citations/anti-leak)
│
├── internal_testing/
