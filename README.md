...
│   └── prompts/             # tutor_01.txt .. tutor_06.txt (versioned system prompts; tutor_06 is the current default, adds LaTeX math formatting)
│
├── internal_testing/
